...
function AgentCard({ agent }: { agent: Agent }) {
  return (
    <div className="group bg-white/5 hover:bg-white/[0.08] border border-white/10 hover:border-white/20 backdrop-blur rounded-2xl p-5 flex flex-col gap-4 transition-all duration-200">
      ...
      <div className="flex items-start justify-between">
        ...
        {/* 3-dot menu */}
        <button className="p-1.5 rounded-lg text-white/30 hover:text-white/70 hover:bg-white/10 transition-colors -mr-0.5 -mt-0.5">
  ...
  return (
    <div className="p-8 space-y-6 max-w-[1400px]">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white tracking-tight">Meus Agentes</h1>
